...
async function sendSMSNotification(selectedDate, timeSlot, activityType, film) {
  ...
  const messageText = isEatOut
    ? `HII YENNIE, this is kitty kit kit. Our eat out schedule is officially confirmed for ${selectedDate} (${timeSlot})! Can't wait to celebrate our hangout with you. See you there! 🍕🎉`
    : `HII YENNIE, this is kitty kit kit. Your Spider-Man movie hangout schedule is officially confirmed for ${selectedDate} (${timeSlot})! Can't wait to celebrate our hangout with you. See you at the movies! 🍿🎉`;
